...
waybar_config_laptop="$HOME/.config/waybar/config" 
...
while true; do
  echo "${NOTE} ${SKY_BLUE} By default, these dots are configured for 1440p or 2k."
...
while true; do
    echo -e "${NOTE} ${SKY_BLUE} By default, These dots are configured in 24H clock format."
...
printf "\n%.0s" {1..2}
printf "${OK} GREAT! The dots are now Loaded & Ready !!! "
printf "\n%.0s" {1..1}
